    ...
    try:
        with get_connection() as conn:
            ...
            if not market_data.empty:
                rising_rate = market_data['rising_rate'].iloc[0]
                if rising_rate < 30:
                    return "30%"
                elif rising_rate < 50:
                    return "50%"
                ...
                try:
                    ...
                    if not last_trade.empty:
                        ...
                        if trade_type == 'BUY':
                            ...
                            # 데이터프레임 생성
                            # streamlit_0218.py의 포지션 정보 표시 부분 수정
                            position_data = {
                                ...
                                '매수비율': [f"{get_buy_ratio(entry_time)}"]  # 매수 비율 추가
                            }
